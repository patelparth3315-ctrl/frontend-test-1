  ...
  return (
    <div className="bg-white min-h-screen font-montserrat">
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-20 h-[500px] md:h-[600px]">
          {/* Column 1: Vertical Tall */}
          <div className="md:col-span-1 relative rounded-[32px] overflow-hidden shadow-2xl group">
            <Image 
          ...
          {/* Column 4: Vertical Tall + See All */}
          <div className="md:col-span-1 relative rounded-[32px] overflow-hidden shadow-2xl group">
            <Image 
        ...
        <div className="flex flex-wrap gap-x-16 gap-y-8 mb-20 py-8 border-y border-zinc-100">
          {[
            ...
            <div key={i} className="flex items-center gap-4">
              <div className="w-12 h-12 flex items-center justify-center text-primary-orange">
                <info.icon className="w-8 h-8" />
              </div>
              <div>
                <p className="text-zinc-500 font-bold text-lg leading-none mb-1">{info.label}</p>
                <p className="text-zinc-400 font-medium">{info.val}</p>
              </div>
            </div>
          ))}
        </div>
